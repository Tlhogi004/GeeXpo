			...
			<tbody>
				<tr>
							...
							<tbody>
								<tr>
									<div id="side-bar-left" style="margin-top: 10.8px; margin-left: 1px; margin-right: 1px; text-decoration: none; width: 10%;">
										<ul>
											<img src="Images/admin.ico" alt="britehouse_icon" style="width: 80px; border: 2px solid lightblue; border-radius: 40px; margin-left: 50px;">
											<label style="font-size: 14px; color: lightgrey; display: inline; margin-left: 60px;">Welcome, <p style="color: white; font-size: 16px; text-transform:capitalize; text-align: center; margin-left: 60px;">mr. molwana</p></label>
											...
											<li style="border-bottom: 1px solid rgba(69, 74, 84, 0.7);" onclick="location.href='index.html';"><a href="index.html" onclick="profilemanagement_display();">LOGOUT</a></li>
										</ul>
									</div>
								</tr>
							</tbody>
							...
							<tbody>
								<tr>
									<div id="dashboard" style="width: 100%; height: 50px; border-bottom: 1.5px solid grey; line-height: 50px; margin-bottom: 10px; ">
										...
										<a style="padding: 10px; color: grey; font-size: 12px; text-decoration: none; margin-right: 0px; border-right: 1px dotted grey; text-align: center;">DRIVER 5</a>
					...
					<td id="truckmanagement-td" style="display: none; width: 100%; margin-top: 10.8px; vertical-align: top; margin-right: 5px;">
						...
						<input type="button" id="addcustomer" name="addcustomer" value="ADD VEHICLE" style="background-color: #00a651; color: white; border: none; border-radius: 2px; margin-bottom: 10px; text-align: right; margin-left: 89%; margin-right: 0; cursor: pointer;">
						      ...
						      <tbody>
						        <?php while($row1 = mysqli_fetch_array($result4)):;?>
									<tr>
										...
										<td><?php echo $row1[5];?></td>
										<td><?php echo $row1[6];?></td>
										<td style="text-align: right;"><input type="submit" value="EDIT" style="width: 100px;"></td>
						      ...
						      <tbody>
						        <?php while($row1 = mysqli_fetch_array($result5)):;?>
									<tr>
										...
										<td></td>
										<td style="text-align: right;"><input type="submit" value="EDIT" style="width: 100px; margin-bottom: 5px;"><input type="submit" value="DELETE" style="width: 100px;"></td>
									</tr>
								<?php endwhile;?>
						      </tbody>
						    </table>
					...
					<td id="customerdata-td" style="display: none; width: 100%; margin-top: 10.8px; vertical-align: top; margin-right: 5px;">
						...
						<input type="button" id="addcustomer" name="addcustomer" value="ADD CUSTOMER" style="background-color: #00a651; color: white; border: none; border-radius: 2px; margin-bottom: 10px; text-align: right; margin-left: 89%; margin-right: 0; cursor: pointer;">
						<section style="background: -webkit-linear-gradient(left, #25c481, #25b7c4);background: linear-gradient(to right, #25c481, #25b7c4);">
						  <!--for demo wrap-->
						  <div id="tbl-header">
								<table cellpadding="0" cellspacing="0" border="0">
